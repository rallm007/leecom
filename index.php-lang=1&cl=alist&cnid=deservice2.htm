...
<head>
                            <title>JUWEL庐 Aquarium | Downloadcenter</title>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <meta name="viewport" content="width=1024" />
                <meta name="description" content="You are here  Service - Downloadcenter. Home">
                <meta name="keywords" content="service, downloadcenter, german, italian, english, french, russian, dutch, further, languages">
    	    <meta property="og:locale" content="en_GB" />
    <meta property="fb:app_id" content="532575290153827" />
    	                                <link rel="canonical" href="http://www.juwel-aquarium.de/en/Service/Downloadcenter/">
...
<li class="search-extended">
    <form action="http://www.juwel-aquarium.de/index.php?lang=1&" method="get" name="search">
        <input type="hidden" name="stoken" value="A9567ED0"><input type="hidden" name="force_sid" value="">
...
<!-- /Navi ohne Warenkorb -->
    ...
    <div class="drop">
        <ul>
                    ...
                    <li><a class="fr_FR" title="Fran莽ais" href="fr/Services/Downloadcenter/index.htm" tppabs="http://www.juwel-aquarium.de/fr/Services/Downloadcenter/" hreflang="fr" onclick="_gaq.push(['_trackEvent', 'Sprachselektor', 'click', 'Fran莽ais']);">Fran莽ais</a></li>
                    <li><a class="ru_RU" title="袪褍褋褋泻懈泄" href="ru/Cervis/Downloadcenter/index.htm" tppabs="http://www.juwel-aquarium.de/ru/Cervis/Downloadcenter/" hreflang="ru" onclick="_gaq.push(['_trackEvent', 'Sprachselektor', 'click', '袪褍褋褋泻懈泄']);">袪褍褋褋泻懈泄</a></li>
...
<div class="page_margins">
    ...
    <div class="breadcrumb nav clearfix">
        <ul class="fl">
            <li>You are here:</li>
            	            	            <li><a href="en/Service/index.htm" tppabs="http://www.juwel-aquarium.de/en/Service/">Service</a></li>
    ...
    <!-- Links - Navigation und Teaser-Content -->
    	<div class="grid_3 alpha nav">
    		<ul class="sub-nav simple">
    	    					    			    			    <li>
		        	<a href="en/Service/FAQ/index.htm" tppabs="http://www.juwel-aquarium.de/en/Service/FAQ/">FAQ</a>
		        </li>
			    ...
			    <li class="active">
			    	...
			    	<span>Newsletter</span>
			        						<ul style="display: none;">
				        				        					        						        												                      		<li><a href="index-1.php-lang=1&cl=newsletter.htm" tppabs="https://www.juwel-aquarium.de/index.php?lang=1&cl=newsletter">Newsletter subscription</a></li>
		                      					        					        						</ul>
...
<script>
    ...
    <div class="grid_8 push_1" >
        ...
        <div class="clearfix downloads">
			<h2 class="tk-myriad-pro tk-light">Find easily the needed Documents</h2>
            <p class="introduction">You can quickly and easily find all documents relating to JUWEL products in the download centre. To do so, please select the language first and then navigate to the desired product or product group.</p>
	        				        
	                   	<form method="post" action="">
              	<div class="doc-finder state-1" id="doc-finder-1" style="z-index: 1000;">            	    <label for="category" class="clear fl clearfix"><span>Please choose a language</span> <a class="icon-info" title="Please choose a language"></a></label>
               	    <select name="category" id="category" class="transform" onchange="filterDocs(this,1);">
               	        <option>Please choose</option>
	                	    	                	        <option value="937e01a43629c62e212c8ee6c41d45f8">English</option>
	                	    	                	        <option value="dedownload1">German</option>
	                	    	                	        <option value="f224ad5fb5ca81d1f0523d8e69a7939d">French</option>
	                	    	                	        <option value="f22773b5b96ab07bcd8785c83df06e69">Further Languages</option>
	                	    	                	        <option value="9qo9eab98fbdb015dca5ae03f7399f56">Russian</option>
	                	    	                	        <option value="h9q7684eefce48507575be4bdfafe5fc">Dutch</option>
	                	    	                	        <option value="0dh429dd3d83d24e94b6de5c24ebf2ba">Italian</option>
	                	                        </select>
...
<script>
	...
	function filterDocs(elem,iLevel) {
		...
		if($(elem).prop('selectedIndex') >= 1) {
		    $.ajax({
		        url: "index.php-lang=1&cl=srajax.htm"/*tpa=http://www.juwel-aquarium.de/index.php?lang=1&cl=srajax*/,
		        type: "POST",
		        dataType: "html",
		        cache: false,
		        data: sData,
...
<!-- Footer-Area -->
    ...
    <div class="page_margins">
        <ul>
						    <li><a href="en/Service/index.htm" tppabs="http://www.juwel-aquarium.de/en/Service/" title="Service">Service</a></li>
			    						    <li><a href="en/Service/Downloadcenter/index.htm" tppabs="http://www.juwel-aquarium.de/en/Service/Downloadcenter/" title="Downloadcenter">Downloadcenter</a></li>
			    			        </ul>                        
    </div>
</div>
<div id="footer">
