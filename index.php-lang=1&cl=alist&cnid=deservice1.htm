...
<head>
                            <title>JUWEL庐 Aquarium | FAQ</title>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
    <meta name="viewport" content="width=1024" />
                <meta name="description" content="You are here  Service - FAQ. Home">
                <meta name="keywords" content="service, faq, aquarium/cabinet, lightning, filtering, common, decoration">
    	    <meta property="og:locale" content="en_GB" />
    <meta property="fb:app_id" content="532575290153827" />
    	                                <link rel="canonical" href="http://www.juwel-aquarium.de/en/Service/FAQ/">
...
<!-- /Navi ohne Warenkorb -->
    ...
    <div class="drop">
        <ul>
                    ...
                    <li><a class="fr_FR" title="Fran莽ais" href="fr/Services/Questions-et-reponses/index.htm" tppabs="http://www.juwel-aquarium.de/fr/Services/Questions-et-reponses/" hreflang="fr" onclick="_gaq.push(['_trackEvent', 'Sprachselektor', 'click', 'Fran莽ais']);">Fran莽ais</a></li>
                    <li><a class="ru_RU" title="袪褍褋褋泻懈泄" href="ru/Cervis/Chasto-zadavaemye-voprosy/index.htm" tppabs="http://www.juwel-aquarium.de/ru/Cervis/Chasto-zadavaemye-voprosy/" hreflang="ru" onclick="_gaq.push(['_trackEvent', 'Sprachselektor', 'click', '袪褍褋褋泻懈泄']);">袪褍褋褋泻懈泄</a></li>
    		...
    		<ul class="sub-nav simple">
			    ...
			    <li class="active">
			        <span>FAQ</span>
		        	    					    			    			    ...
		        	    					    			    			    <li>
		        	<a href="en/Service/Downloadcenter/index.htm" tppabs="http://www.juwel-aquarium.de/en/Service/Downloadcenter/">Downloadcenter</a>
		        </li>
		        			        
		        	    					    			    			    <li class="has-sub">
			    	<span>Newsletter</span>
			        						<ul style="display: none;">
				        				        					        						        												                      		<li><a href="index.php-lang=1&force_sid=rourg7mdqqqm5ppt19cs5hlfm7&cl=newsletter.htm" tppabs="https://www.juwel-aquarium.de/index.php?lang=1&force_sid=rourg7mdqqqm5ppt19cs5hlfm7&cl=newsletter">Newsletter subscription</a></li>
		                      					        					        						</ul>
...
Hint:
Fill the aquarium through the filter box in order to minimise the disturbance of your d茅cor.
...
This complex production process makes it particularly easy to cut the colour backgrounds to size whilst providing an extremely tough, colourfast surface. </p></div>
            ...
            <!-- Formular -->
                ...
                <h2 class="tk-myriad-pro tk-light">Were your questions not answered?</h2>
                <p>Simply share your question with us here and we will answer it for you as quickly as possible.<br>Please note that inquiries can be answered only in English or German.</p>
                <form class="jqtransform" onSubmit="return false;">
                    <div>
                                                <input type="hidden" name="c_mach" value="roubc846563abf6314226dcd7d818e00"/>
                    </div>
    ...
    <option value="MRS">Mrs</option>
									...
									<label class="clearfix"><span>E-Mail*</span> <a class="icon-info" title=""></a></label>
                        ...
                        <div class="form-col faqform-product fr">
                            <div class="inner">
                                ...
                                <div class="form-row form-textarea">
                                    ...
                                    <textarea name="srfaq__note" rows="15" cols="34" placeholder="Please make your request exclusively in German or English!"></textarea>
                                </div>
                                <div class="form-row form-text required captcha-faq">

                                    <label>Enter Verification code:*</label>
                                                                                                                <label class="captcha-copy--faq">Code:</label>
                                        <img class="captcha-faq--image" id="verifyImageUrl" src="core/utils/verificationimg.php-e_mac=ox_DRMTUwJdBUJE.png" tppabs="http://www.juwel-aquarium.de/core/utils/verificationimg.php?e_mac=ox_DRMTUwJdBUJE" alt="">
                    ...
                    <div class="checkout-bottom-buttons clearfix">
                        <button class="button green-right w180 fr">Subscribe</button>
            ...
            <div class="form-confirm" style="display:none;">
                <h2 class="tk-myriad-pro tk-light">Thank You!</h2>
                <p>Questions and suggestions from our customers are always welcome. That's why our Service team are always on hand to help you. Write and tell us what is on your mind. We will endeavour to process your enquiry within two working days. </p>
            </div>

            <div class="go-top clear clearfix"> <a class="arrow-link top fr scroll-link" href="#header">Go to top</a> </div>
        </div>
    </div>
    ...
    <div class="page_margins">
        <ul>
						    <li><a href="en/Service/index.htm" tppabs="http://www.juwel-aquarium.de/en/Service/" title="Service">Service</a></li>
			    						    <li><a href="en/Service/FAQ/index.htm" tppabs="http://www.juwel-aquarium.de/en/Service/FAQ/" title="FAQ">FAQ</a></li>
			    			        </ul>                        
    </div>
</div>
<div id="footer">
    <div class="page_margins bg">
        	...
        	<h4>Service</h4>
				...
				<ul>
                                   	                   		<li><a href="en/Service/FAQ/index.htm" tppabs="http://www.juwel-aquarium.de/en/Service/FAQ/" onclick="_gaq.push(['_trackEvent', 'FAQ Quelle', 'click', 'Servicecenter']);">FAQ</a></li>
                   	                                   	                   		<li><a href="en/Service/Downloadcenter/index.htm" tppabs="http://www.juwel-aquarium.de/en/Service/Downloadcenter/" onclick="_gaq.push(['_trackEvent', 'Downloadquelle', 'click', 'Downloadcenter']);">Downloadcenter</a></li>
                   	                                   	                   		<li><a href="index.php-lang=1&force_sid=rourg7mdqqqm5ppt19cs5hlfm7&cl=newsletter.htm" tppabs="https://www.juwel-aquarium.de/index.php?lang=1&force_sid=rourg7mdqqqm5ppt19cs5hlfm7&cl=newsletter">Newsletter</a></li>
                   	                	            </ul>
					</div>
