...
<script>
	...
	loadContentByArtId = function( sArtId ) {
		...
		if(window.location.protocol.indexOf("https") >= 0) {
			var sUrl = "https://www.juwel-aquarium.de/cn/Products/Aquariums/XP-Line/XP-300-black-XP-300-Black.php#!juwel-000000000000007300cl=srajax";
		} else {
    ...
    <div class="page_margins">
        <ul>
						    <li><a href="../../index.php" title="Products">Products</a></li>
			    						    <li><a href="XP-125-black.php" title="XP系列">XP系列</a></li>
			    			        </ul>                        
    </div>
</div>
