...
<script>
	...
	loadContentByArtId = function( sArtId ) {
		...
		if(window.location.protocol.indexOf("https") >= 0) {
			var sUrl = "https://www.juwel-aquarium.de/cn/Products/Aquariums/XC-Line/Vision-450-black.php#!juwel-000000000000010300cl=srajax";
		} else {
    ...
    <div class="page_margins">
        <ul>
						    <li><a href="../../index.php" title="Products">Products</a></li>
			    						    <li><a href="Vision-180-black.php" title="XC系列">XC系列</a></li>
			    			        </ul>                        
    </div>
</div>
