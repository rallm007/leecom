...
<div class="product-thumbnail-navi clearfix closed">
	<div class="page_margins">
    	<div class="inner-wrapper">
            ...
            <a id="thumb-product-prev" class="ir prod-thumb-nav" href="#">上一页>上一页</a>
            <div class="slider-wrapper">
                <div class="product-thumbnail-slider clearfix">
                        ...
                        <img data-src="<?php echo $site_url;?>out/pictures/master/product/7/06800.png" alt="XC 360 ">
                        XC 360 
                    </a>
                        ...
                        <img data-src="<?php echo $site_url;?>out/pictures/master/product/7/10300.png" alt="XC 400 ">
                        XC 400 
                    </a>
                                                </div>
            </div>
...
<div class="product-detail-stage" style="background-color:#00508c; background-image:url(<?php echo $site_url;?>out/juwel/src/images/all/content-product-detail-stage_bgImage.jpg)"><!-- Hier kann der "Haupt-Hintergrund" gesetzt werden -->
	...
	<div class="stage-slider">
	            ...
	            <div class="page_margins item-content">
	                ...
	                <div class="right">
	                    ...
	                    <div class="variations nav clearfix">
	                        <div class="oh">
		                            <ul>
																			<li><a href="Vision-180-black.php#!juwel-xc300b" title="XC 300 黑色"><img src="<?php echo $site_url;?>out/pictures/master/global/2/1.png" width="33" height="33" alt=""></a></li>
																			<li><a href="Vision-180-white.php#!juwel-xc300w" title="XC 300 白色"><img src="<?php echo $site_url;?>out/pictures/master/global/2/4.png" width="33" height="33" alt=""></a></li>
																			</ul>
		                        </div>
	        ...
	        <div class="item" id="juwel-xc360b" data-variants="juwel-xc360b juwel-xc360w juwel-000000000000006550 juwel-000000000000006700"><!-- hier als id den Produktnamen(z.B.) setzen -> wichtig für navigation: in thumbnail-navigation (href="#vision180") -->
	            <div class="page_margins item-content">
	                ...
	                <div class="right">
	                    ...
	                    <div class="variations nav clearfix">
	                        <div class="oh">
		                            <ul>
																			<li><a href="Vision-260-black.php#!juwel-xc360b" title="XC 360 黑色"><img src="<?php echo $site_url;?>out/pictures/master/global/2/1.png" width="33" height="33" alt=""></a></li>
																			<li><a href="Vision-260-white.php#!juwel-xc360w" title="XC 360 白色"><img src="<?php echo $site_url;?>out/pictures/master/global/2/4.png" width="33" height="33" alt=""></a></li>
																			</ul>
		                        </div>
	                        <!-- Auswahl-Slider unter runden Dekor-Bildern -->
	                        <div class="variations-slider-wrapper">
	            ...
	            <!-- versteckte Elemente -->
	            <div class="hidden">
	            	<img class="nav-product-preview-image" src="<?php echo $site_url;?>out/pictures/master/product/8/06800.png" alt="XC 360 ">
	            	<!-- kleines Bild des Aquariums sichtbar in Slider-Navigation (Button-Preview) -->
	        ...
	        <div class="item" id="juwel-xc400b" data-variants="juwel-xc400b juwel-xc400w juwel-000000000000010550 juwel-000000000000010700"><!-- hier als id den Produktnamen(z.B.) setzen -> wichtig für navigation: in thumbnail-navigation (href="#vision180") -->
	            <div class="page_margins item-content">
	                ...
	                <div class="right">
	                    ...
	                    <div class="variations nav clearfix">
	                        <div class="oh">
		                            <ul>
																			<li><a href="Vision-450-black.php#!juwel-xc400b" title="XC 400 黑色"><img src="<?php echo $site_url;?>out/pictures/master/global/2/1.png" width="33" height="33" alt=""></a></li>
																			<li><a href="Vision-450-white.php#!juwel-xc400w" title="XC 400 白色"><img src="<?php echo $site_url;?>out/pictures/master/global/2/4.png" width="33" height="33" alt=""></a></li>
																			</ul>
		                        </div>
	                        <!-- Auswahl-Slider unter runden Dekor-Bildern -->
	                        <div class="variations-slider-wrapper">
	            ...
	            <!-- versteckte Elemente -->
	            <div class="hidden">
	            	<img class="nav-product-preview-image" src="<?php echo $site_url;?>out/pictures/master/product/8/10300.png" alt="XC 400 ">
	            	<!-- kleines Bild des Aquariums sichtbar in Slider-Navigation (Button-Preview) -->
...
<script>
	...
	loadContentByArtId = function( sArtId ) {
		...
		if(window.location.protocol.indexOf("https") >= 0) {
			var sUrl = "https://www.juwel-aquarium.de/cn/Products/Aquariums/XC-Line/Vision-180-black.php#!juwel-xc300bcl=srajax";
		} else {
