    ...
    <ul class="fl">
        ...
        <div class="stage-slider clearfix">	
				                ...
				                <div class="image">
				                    ...
				                    <img src="../../out/pictures/master/category/promo_icon/00000000031.png" alt="" width="347" height="420"><!-- "großes" Bild der系列 (width und height muss angegeben werden) -> wird automatisch klein skaliert im Slider für die kleine, nicht aktive Ansicht (deshalb nur ein Bild benötigt) -->				                    
				                </div>
				                <div class="line-info">
				                ...
				                <div class="image">
				                    ...
				                    <img src="../../out/pictures/master/category/promo_icon/00000000041.png" alt="" width="347" height="420"><!-- "großes" Bild der系列 (width und height muss angegeben werden) -> wird automatisch klein skaliert im Slider für die kleine, nicht aktive Ansicht (deshalb nur ein Bild benötigt) -->				                    
				                </div>
				                <div class="line-info">
				                    <div class="inner clearfix">
				                ...
				                <div class="image">
				                    ...
				                    <img src="../../out/pictures/master/category/promo_icon/00000000051.png" alt="" width="347" height="420"><!-- "großes" Bild der系列 (width und height muss angegeben werden) -> wird automatisch klein skaliert im Slider für die kleine, nicht aktive Ansicht (deshalb nur ein Bild benötigt) -->				                    
				                </div>
				                <div class="line-info">
				                    <div class="inner clearfix">
				                        ...
				                        <a href="Aquariums/XT-Line/XT-190-black.php#!juwel-000000000000015300"><!-- Link zu der ensprechenden Produkt-Detail-Seite - Die jeweilige Variante kann mit z.B. "#vision180" angewählt werden (siehe "partial/produkt-detail/produkt-detail-stage.php" in Zeile 60) -->
				                ...
				                <div class="image">
				                    ...
				                    <img src="../../out/pictures/master/category/promo_icon/00000000061.png" alt="" width="347" height="420"><!-- "großes" Bild der系列 (width und height muss angegeben werden) -> wird automatisch klein skaliert im Slider für die kleine, nicht aktive Ansicht (deshalb nur ein Bild benötigt) -->				                    
				                </div>
				                <div class="line-info">
				                    <div class="inner clearfix">
				                        ...
				                        <a href="Aquariums/XE-Line/XE-120-black.php#!juwel-000000000000011830"><!-- Link zu der ensprechenden Produkt-Detail-Seite - Die jeweilige Variante kann mit z.B. "#vision180" angewählt werden (siehe "partial/produkt-detail/produkt-detail-stage.php" in Zeile 60) -->
				                ...
				                <div class="image">
				                    ...
				                    <img src="../../out/pictures/master/category/promo_icon/00000000071.png" alt="" width="347" height="420"><!-- "großes" Bild der系列 (width und height muss angegeben werden) -> wird automatisch klein skaliert im Slider für die kleine, nicht aktive Ansicht (deshalb nur ein Bild benötigt) -->				                    
				                </div>
				                <div class="line-info">
				                    <div class="inner clearfix">
				                    					                    	
				                        <a href="Aquariums/XK-Line/XK-600-black-Int.php#!juwel-000000000000021600"><!-- Link zu der ensprechenden Produkt-Detail-Seite - Die jeweilige Variante kann mit z.B. "#vision180" angewählt werden (siehe "partial/produkt-detail/produkt-detail-stage.php" in Zeile 60) -->
				                        ...
				                        <a href="Aquariums/XK-Line/XK-600-black.php#!juwel-000000000000021700"><!-- Link zu der ensprechenden Produkt-Detail-Seite - Die jeweilige Variante kann mit z.B. "#vision180" angewählt werden (siehe "partial/produkt-detail/produkt-detail-stage.php" in Zeile 60) -->
				                ...
				                <div class="image">
				                    ...
				                    <img src="../../out/pictures/master/category/promo_icon/00000001271.png" alt="" width="347" height="420"><!-- "großes" Bild der系列 (width und height muss angegeben werden) -> wird automatisch klein skaliert im Slider für die kleine, nicht aktive Ansicht (deshalb nur ein Bild benötigt) -->				                    
				                </div>
				                <div class="line-info">
				                    <div class="inner clearfix">
