...
<div class="product-thumbnail-navi accessories_detail-thumb-nav clearfix">
    <div class="page_margins ">
        <h1 class="tk-myriad-pro tk-light">PS水泵系列</h1>
            ...
            <div class="slider-wrapper">
                <div class="product-thumbnail-slider clearfix">
                                        <a href="PS-315.php" title="PS-315 " class="selected">
                                        <img src="<?php echo $site_url;?>out/b/77/ps315.png" alt="PS-315 ">
                                                                        </a>
                                        <a href="PS-3w5.php" title="PS-325 ">
                                        <img src="<?php echo $site_url;?>out/b/77/ps325.png" alt="PS-325 ">
                                                                        </a>
                                                                        <a href="PS-335.php" title="PS-335 ">
                                        <img src="<?php echo $site_url;?>out/b/77/ps315.png" alt="PS-335 ">
                                                                        </a>
                                    </div>
            </div>
    ...
    <ul class="fl">
        <li>您的位置:</li>
                                            <li><a href="../../index.php" title="产品展示">产品展示</a></li>
                                                            ...
                                                            <li><a href="PF-120.php" title="PF水泵系列">PS水泵系列</a></li>
                                        <li>PS-315 </li>
            </ul>
</div>  
...
<div class="tabs product-images">
    <div id="image-1">
        <a href="<?php echo $site_url;?>out/b/863/ps315.jpg" class="cloud-zoom">
            <img src="<?php echo $site_url;?>out/b/278/ps315.png" alt="" width="278" height="278">
        </a>
    </div>
     <!-- Bilder-Navigation -->
     <div class="clearfix">
                    <ul class="product-images-nav clearfix">
                            <li><a href="#image-1"><img src="<?php echo $site_url;?>out/b/50/ps315.png" alt=""></a></li>
                        </ul>
            </div>
    <!-- ende -> Tab-Navigation -->
</div>
...
<h2 class="tk-myriad-pro tk-light">PS-315 </h2>
...
<p><br/><br/>PS-315,325,335一共3个型号满足您不同的使用需求。<br />
</p>
<p><br />
        </div>
