        ...
        <h1 class="tk-myriad-pro tk-light">磁擦系列</h1>
            ...
            <div class="slider-wrapper">
                <div class="product-thumbnail-slider clearfix">
                                        <a href="CC1.php" title="河马磁擦 " class="selected">
...
<div class="tabs product-images">
    <div id="image-1">
        <a href="<?php echo $site_url;?>out/b/863/cc1.jpg" class="cloud-zoom">
            <img src="<?php echo $site_url;?>out/b/278/cc1.png" alt="" width="278" height="278">
        </a>
    </div>
     <!-- Bilder-Navigation -->
     <div class="clearfix">
                    <ul class="product-images-nav clearfix">
                            <li><a href="#image-1"><img src="<?php echo $site_url;?>out/b/50/cc1.png" alt=""></a></li>
                        </ul>
            </div>
    <!-- ende -> Tab-Navigation -->
</div>
...
<h2 class="tk-myriad-pro tk-light">河马磁擦 </h2>
