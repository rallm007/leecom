            ...
            <div class="slider-wrapper">
                <div class="product-thumbnail-slider clearfix">
                                        ...
                                        <img src="<?php echo $site_url;?>out/b/77/hi330.png" alt="HI-330 ">
                                                                        ...
                                                                        <a href="HI-430.php" title="HI-430 ">
                                        ...
                                        <img src="<?php echo $site_url;?>out/b/77/hi530.png" alt="HI-530 ">
                                                                        ...
                                                                        <a href="HI-630.php" title="HI-630 " class="selected">
    ...
    <ul class="fl">
        <li>您的位置:</li>
                                            <li><a href="../index.php" title="产品展示">产品展示</a></li>
                                                            <li><a href="../index.php" title="HI缸外过滤系列">HI缸外过滤系列</a></li>
                                        <li>HI-630 </li>
            </ul>
</div>  
    ...
    <li class="active">     
        <span>HI缸外过滤系列</span>
            ...
            <li class="active">
                        <ul>
                <li>
                    <a href="HI-330.php">HI-330 </a>                  
                </li>
            </ul>
            <ul>
                <li>
                    <a href="HI-430.php">HI-430 </a>                  
                </li>
            </ul>
            <ul>
                <li>
                    <a href="HI-530.php">HI-530 </a>                  
                </li>
            </ul>
            <ul>
                <li class="active">
                    <a href="HI-630.php">HI-630 </a>                  
                </li>
            </ul>
                        </li>
        </ul>
...
<div class="tabs product-images">
    <div id="image-1">
        <a href="<?php echo $site_url;?>out/b/863/hi630.jpg" class="cloud-zoom">
            <img src="<?php echo $site_url;?>out/b/278/hi630.png" alt="" width="278" height="278">
        </a>
    </div>
     <!-- Bilder-Navigation -->
     <div class="clearfix">
                    <ul class="product-images-nav clearfix">
                            <li><a href="#image-1"><img src="<?php echo $site_url;?>out/b/50/hi630.png" alt=""></a></li>
                        </ul>
            </div>
    <!-- ende -> Tab-Navigation -->
</div>
...
<h2 class="tk-myriad-pro tk-light">HI-630 </h2>
<p class="desc"></p>
        </div>                
        </div>
        <!-- ende -> oberer Bereich-->
        ...
        <div class="tab-teaser accessories_detail-prod_detail">
            <h3>HI-630</h3>
            <p>时尚美观，瀑布式流水设计，高仿大自然的流水规律，超静，仅听见潺潺流水的声音，为鱼儿提供充足的氧气，令鱼儿更活跃，水族世界更精彩。外壳采用优质增强型ABS原材料，坚固耐用，防腐蚀、耐酸碱、经久耐用，性能更卓越，过滤泵头主体部份全部采用进口铜线，性能更高，更有效省电，顶部灌胶密封，杜绝漏电安全隐患。三重过滤的炭棉板滤材，不但替换方便，性能更出色，当中的高效活性炭有效净化水质，令水质更清澈；高密度过滤棉可吸附水族箱内残留的鱼铒、鱼烘等杂质，和高效生化棉最大程度保证水质的洁净。可调试流量的调节阀，自由调节最适合水流量及溶氧量以供生物生长，专业油膜处理技术，独特的油膜吸头设计，使之高效快速吸收水面油膜，以给您的爱鱼一个最洁净而温馨的家。</p>
