...
<div class="simple-stage">
        ...
        <h1 class="tk-myriad-pro tk-light">缸内过滤系列</h1>
        <p>还您一个宁静的世界</p>
    </div>
    </div>
...
<div class="product-thumbnail-navi accessories_detail-thumb-nav clearfix">
    <div class="page_margins ">
        <h1 class="tk-myriad-pro tk-light">PF-2系列</h1>
            ...
            <div class="slider-wrapper">
                <div class="product-thumbnail-slider clearfix">
                                        <a href="PF-282.php" title="PF-282 ">
                                        <img src="<?php echo $site_url;?>out/b/77/pf282.png" alt="PF-282 ">
                                                                        </a>
                                        <a href="PF-283.php" title="PF-283 ">
                                        <img src="<?php echo $site_url;?>out/b/77/pf283.png" alt="PF-283 ">
                                                                        </a>
                                                                        <a href="PF-284.php" title="PF-284 " class="selected">
                                        <img src="<?php echo $site_url;?>out/b/77/pf284.png" alt="PF-284 ">
                                                                        </a>
                                                                        <a href="PF-285.php" title="PF-285 ">
                                        <img src="<?php echo $site_url;?>out/b/77/pf285.png" alt="PF-285 ">
                                                                        </a>
                                                                        <a href="PF-286.php" title="PF-286 ">
                                        <img src="<?php echo $site_url;?>out/b/77/pf286.png" alt="PF-286 ">
                                                                        </a>
                                    </div>
            </div>
    ...
    <ul class="fl">
        <li>您的位置:</li>
                                            <li><a href="../index.php" title="产品展示">产品展示</a></li>
                                                            <li><a href="../index.php" title="缸内过滤系列">缸内过滤系列</a></li>
    ...
    <li class="active">     
        <span>PF-2系列</span>
            ...
            <li class="active">
                        <ul>
                <li>
                    <a href="PF-282.php">PF-282 </a>                  
                </li>
            </ul>    
                        <ul>
                <li>
                    <a href="PF-283.php">PF-283 </a>                  
                </li>
            </ul>    
                        <ul>
                <li class="active">
                    <a href="PF-284.php">PF-284 </a>   
                </li>
            </ul>    
                        <ul>
                <li>
                    <a href="PF-285.php">PF-285 </a>   
                </li>
            </ul>    
                        <ul>
                <li>
                    <a href="PF-286.php">PF-286 </a>   
                </li>
            </ul>     
                        </li>
        </ul>
    ...
    <li>        
        <span>PS系列</span>
            ...
            <li class="active">
                        <ul>
                <li>
                    <a href="PS-618.php">PS-618 </a>                  
                </li>
            </ul>    
                        <ul>
                <li>
                    <a href="PS-628.php">PS-628 </a>
                </li>
            </ul>    
                        <ul>
                <li>
                    <a href="PS-638.php">PS-638 </a>
                </li>
            </ul>
                        </li>
        </ul>
...
<div class="tabs product-images">
    <div id="image-1">
        <a href="<?php echo $site_url;?>out/b/863/pf284.jpg" class="cloud-zoom">
            <img src="<?php echo $site_url;?>out/b/278/pf284.png" alt="" width="278" height="278">
        </a>
    </div>
     <!-- Bilder-Navigation -->
     <div class="clearfix">
                    <ul class="product-images-nav clearfix">
                            <li><a href="#image-1"><img src="<?php echo $site_url;?>out/b/50/pf284.png" alt=""></a></li>
                        </ul>
            </div>
    <!-- ende -> Tab-Navigation -->
</div>
...
<h2 class="tk-myriad-pro tk-light">PF-284 </h2>
<p class="desc"></p>
        </div>                
        </div>
        <!-- ende -> oberer Bereich-->
        ...
        <div class="tab-teaser accessories_detail-prod_detail">
            <h3>PF-284</h3>
            <p>过滤、增氧、造浪于一体的三合一过滤器，外壳采用顶级加强型ABS塑料制造而成，过滤泵头主体部份全部采用进口铜线，性能更高，更有效省电，顶部灌胶密封，杜绝漏电安全隐患。多种过滤材质配置在内，起到更好的过滤功能。当中的高效活性炭有效净化水质，令水质更清澈；超大生化棉加大了被过滤面积，从而起到更好的过滤作用。过滤盒可拆卸，可以随时替换滤材以永保水质洁净。特别配置雨淋管和加氧管出水，接法多种多样，可以根据自己需求随意调节流量大小。</p>
