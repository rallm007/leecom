            ...
            <div class="slider-wrapper">
                <div class="product-thumbnail-slider clearfix">
                                        ...
                                        <img src="<?php echo $site_url;?>out/b/77/if732.png" alt="IF-732 ">
                                                                        ...
                                                                        <a href="IF-733.php" title="IF-733 " class="selected">
                                        <img src="<?php echo $site_url;?>out/b/77/if733.png" alt="IF-733 ">
                                                                        </a>
                                                                        <a href="IF-734.php" title="IF-734 ">
...
<div class="tabs product-images">
    <div id="image-1">
        <a href="<?php echo $site_url;?>out/b/863/if733.jpg" class="cloud-zoom">
            <img src="<?php echo $site_url;?>out/b/278/if733.png" alt="" width="278" height="278">
        </a>
    </div>
     <!-- Bilder-Navigation -->
     <div class="clearfix">
                    <ul class="product-images-nav clearfix">
                            <li><a href="#image-1"><img src="<?php echo $site_url;?>out/b/50/if733.png" alt=""></a></li>
                        </ul>
            </div>
    <!-- ende -> Tab-Navigation -->
</div>
...
<h2 class="tk-myriad-pro tk-light">IF-733 </h2>
<p class="desc">我的硝化菌培养专家</p>
        ...
        <div class="tab-teaser accessories_detail-prod_detail">
            <h3>IF-733</h3>
            <p>采用高级环保海棉作为滤材，该生化棉有多层原理设计制造而成，拥有最大的表面积，并没有任何对水流的障碍，与气泵联用可达到增氧与过滤的双重功效。易于清洗，无噪音，大大增加氧气在水中的溶解度，达到洁净、稳定水质的的功效。产品衔街处均可360度旋转，可根据空间需求自由调节，生化棉可拆式设计，清洗更便利。超大吸盘，吸力更强，更稳固，更牢靠。</p>
