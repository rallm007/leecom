            ...
            <div class="slider-wrapper">
                <div class="product-thumbnail-slider clearfix">
                                        ...
                                        <img src="<?php echo $site_url;?>out/b/77/kc362.png" alt="KC-362 ">
                                                                        ...
                                                                        <a href="KC-363.php" title="KC-363 ">
                                        ...
                                        <img src="<?php echo $site_url;?>out/b/77/kc364.png" alt="KC-364 ">
                                                                        ...
                                                                        <a href="KC-365.php" title="KC-365 " class="selected">
...
<div class="tabs product-images">
    <div id="image-1">
        <a href="<?php echo $site_url;?>out/b/863/kc365.jpg" class="cloud-zoom">
            <img src="<?php echo $site_url;?>out/b/278/kc365.png" alt="" width="278" height="278">
        </a>
    </div>
     <!-- Bilder-Navigation -->
     <div class="clearfix">
                    <ul class="product-images-nav clearfix">
                            <li><a href="#image-1"><img src="<?php echo $site_url;?>out/b/50/kc365.png" alt=""></a></li>
                        </ul>
            </div>
    <!-- ende -> Tab-Navigation -->
</div>
...
<h2 class="tk-myriad-pro tk-light">KC-365 </h2>
<p class="desc"></p>
        </div>                
        </div>
        <!-- ende -> oberer Bereich-->
