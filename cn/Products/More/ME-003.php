            ...
            <div class="slider-wrapper">
                <div class="product-thumbnail-slider clearfix">
                                        ...
                                        <img src="<?php echo $site_url;?>out/b/77/me002.png" alt="ME-002 Y型气管三通 ">
                                                                        ...
                                                                        <a href="ME-003.php" title="ME-003 气管接头直通 " class="selected">
...
<div class="tabs product-images">
    <div id="image-1">
        <a href="<?php echo $site_url;?>out/b/863/me003.jpg" class="cloud-zoom">
            <img src="<?php echo $site_url;?>out/b/278/me003.png" alt="" width="278" height="278">
        </a>
    </div>
     <!-- Bilder-Navigation -->
     <div class="clearfix">
                    <ul class="product-images-nav clearfix">
                            <li><a href="#image-1"><img src="<?php echo $site_url;?>out/b/50/me003.png" alt=""></a></li>
                        </ul>
            </div>
    <!-- ende -> Tab-Navigation -->
</div>
...
<h2 class="tk-myriad-pro tk-light">ME-003 气管接头直通 </h2>
<p class="desc"></p>
        </div>                
        </div>
        <!-- ende -> oberer Bereich-->
        ...
        <div class="tab-teaser accessories_detail-prod_detail">
            <h3>ME-003 气管接头直通</h3>
            <p>透明无毒、环保优质PVC材质，在需要把现有的气管接驳得更长的时候气管接头将是您不二的选择。</p>
