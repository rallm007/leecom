				...
				<div class="clearfix accessories_detail_top">
					<div class="grid_4 alpha accessories_detail_images">
						...
						<div class="tabs product-images">
							<div id="image-1">
								<a href="<?php echo $site_url; ?>out/img/detail/2/au312_863.jpg" class="cloud-zoom">
									<img src="<?php echo $site_url; ?>out/img/detail/2/ni318_278.png" alt="" width="278"
										 height="278">
								</a>
							</div>
						</div>
					...
					<div class="grid_4 omega accessories_detail_right" style="margin-top: 100px;">
						...
						<h2 class="tk-myriad-pro tk-light">NI-318 </h2>
						...
						<div id="tabs-1">
							...
							<div class="tab-teaser accessories_detail-prod_detail">
								...
								<p><br/>单孔、双孔出气口满足您不同的鱼缸需求。<br/>
									精心为您准备好的NI-318套装系列，内有气泵，气管，止逆阀，气动过滤器，安装完毕即可立马使用。<br/><br/>
									推荐配套产品:</p>
...
<div id="breadcrumb-bottom" class="nav">
	<div class="page_margins">
		<ul>
			<li><a href="../../../index.php" title="产品展示">产品展示</a></li>
			<li><a href="AQ-202.php" title="气泵系列">气泵系列</a></li>
			<li><a href="NI-318.php" title="NI气泵系列">NI气泵系列</a></li>
		</ul>
	</div>
</div>
