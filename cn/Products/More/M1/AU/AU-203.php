...
<div class="tabs product-images">
    <div id="image-1">
    	<a href="<?php echo $site_url;?>out/b/863/au203.jpg" class="cloud-zoom">
    		<img src="<?php echo $site_url;?>out/b/278/au203.png" alt="" width="278" height="278">
        </a>
    </div>
     <!-- Bilder-Navigation -->
     <div class="clearfix">
     	            <ul class="product-images-nav clearfix">
                            <li><a href="#image-1"><img src="<?php echo $site_url;?>out/b/50/au203.png" alt=""></a></li>
			            </ul>
		    </div>
    <!-- ende -> Tab-Navigation -->
</div>
...
<h2 class="tk-myriad-pro tk-light">AU-203 </h2>
