        ...
        <h1 class="tk-myriad-pro tk-light">保温棒</h1>
            ...
            <div class="slider-wrapper">
                <div class="product-thumbnail-slider clearfix">
                                        <a href="KC-361.php" title="KC-361 ">
                                        <img src="<?php echo $site_url;?>out/b/77/kc361.png" alt="KC-361 ">
                                                                        </a>
                                                                        <a href="KC-362.php" title="KC-362 ">
                                        <img src="<?php echo $site_url;?>out/b/77/kc362.png" alt="KC-362 ">
                                                                        </a>
                                                                        <a href="KC-363.php" title="KC-363 " class="selected">
                                        <img src="<?php echo $site_url;?>out/b/77/kc363.png" alt="KC-363 ">
                                                                        </a>
                                                                        <a href="KC-364.php" title="KC-364 ">
                                        <img src="<?php echo $site_url;?>out/b/77/kc364.png" alt="KC-364 ">
                                                                        </a>
                                                                        <a href="KC-365.php" title="KC-365 ">
                                        <img src="<?php echo $site_url;?>out/b/77/kc365.png" alt="KC-365 ">
                                                                        </a>
                                                                        <a href="KC-366.php" title="KC-366 ">
                                        <img src="<?php echo $site_url;?>out/b/77/kc366.png" alt="KC-366 ">
                                                                        </a>
                                    </div>
            </div>
    ...
    <li class="active">     
        <span>保温棒</span>
            ...
            <li class="active">
                        <ul>
                <li>
                    <a href="KC-361.php">KC-361 </a>                  
                </li>
            </ul>
            <ul>
                <li>
                    <a href="KC-361.php">KC-362 </a>                  
                </li>
            </ul>
            <ul>
                <li class="active">
                    <a href="KC-363.php">KC-363 </a>                  
                </li>
            </ul>
            <ul>
                <li>
                    <a href="KC-364.php">KC-364 </a>                  
                </li>
            </ul>
            <ul>
                <li>
                    <a href="KC-365.php">KC-365 </a>                  
                </li>
            </ul>
            <ul>
                <li>
                    <a href="KC-366.php">KC-366 </a>                  
                </li>
            </ul>
                        </li>
        </ul>
...
<div class="tabs product-images">
    <div id="image-1">
        <a href="<?php echo $site_url;?>out/b/863/kc363.jpg" class="cloud-zoom">
            <img src="<?php echo $site_url;?>out/b/278/kc363.png" alt="" width="278" height="278">
        </a>
    </div>
     <!-- Bilder-Navigation -->
     <div class="clearfix">
                    <ul class="product-images-nav clearfix">
                            <li><a href="#image-1"><img src="<?php echo $site_url;?>out/b/50/kc363.png" alt=""></a></li>
                        </ul>
            </div>
    <!-- ende -> Tab-Navigation -->
</div>
...
<h2 class="tk-myriad-pro tk-light">KC-363 </h2>
<p class="desc"></p>
        </div>                
        </div>
        <!-- ende -> oberer Bereich-->
        ...
        <div class="tab-teaser accessories_detail-prod_detail">
            <h3>KC-363</h3>
            <p>采用防爆石英玻璃管，高效率的加强型陶瓷芯，具有双重绝缘功能、加热速度快，可承受极大的温差，具有安全保护系统。温控器精准，可靠，操作简易，方便安全，硅胶防磁撞保护，淡海水两用。温控区间18℃到32℃，完全潜水，可根据您的不同需要随意调节，超强密封性，防水效果极好。优质橡胶吸盘，摆放灵活。</p>
