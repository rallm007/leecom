        ...
        <h1 class="tk-myriad-pro tk-light">PF水泵系列</h1>
            ...
            <div class="slider-wrapper">
                <div class="product-thumbnail-slider clearfix">
                                        <a href="PF-120.php" title="PF-120 " class="selected">
                                        <img src="<?php echo $site_url;?>out/b/77/pf120.png" alt="PF-120 ">
                                                                        </a>
                                        <a href="PF-130.php" title="PF-130 ">
...
<div class="tabs product-images">
    <div id="image-1">
        <a href="<?php echo $site_url;?>out/b/863/pf120.jpg" class="cloud-zoom">
            <img src="<?php echo $site_url;?>out/b/278/pf120.png" alt="" width="278" height="278">
        </a>
    </div>
     <!-- Bilder-Navigation -->
     <div class="clearfix">
                    <ul class="product-images-nav clearfix">
                            <li><a href="#image-1"><img src="<?php echo $site_url;?>out/b/50/pf120.png" alt=""></a></li>
                        </ul>
            </div>
    <!-- ende -> Tab-Navigation -->
</div>
...
<h2 class="tk-myriad-pro tk-light">PF-120 </h2>
