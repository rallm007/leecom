        ...
        <h1 class="tk-myriad-pro tk-light">磁擦系列</h1>
            ...
            <div class="slider-wrapper">
                <div class="product-thumbnail-slider clearfix">
                                        <a href="CC1.php" title="河马磁擦 ">
                                        <img src="<?php echo $site_url;?>out/b/77/cc1.png" alt="河马磁擦 ">
                                                                        </a>
                                                                        <a href="CC2.php" title="海星磁擦 " class="selected">
                                        <img src="<?php echo $site_url;?>out/b/77/cc2.png" alt="海星磁擦 ">
                                                                        </a>
                                                                        <a href="CC3.php" title="石头鱼磁擦 ">
                                        <img src="<?php echo $site_url;?>out/b/77/cc3.png" alt="石头鱼磁擦 ">
                                                                        </a>
                                                                        <a href="CC4.php" title="海豚磁擦 ">
                                        <img src="<?php echo $site_url;?>out/b/77/cc4.png" alt="海豚磁擦 ">
                                                                        </a>
                                                                        <a href="CC5.php" title="鲨鱼磁擦 ">
                                        <img src="<?php echo $site_url;?>out/b/77/cc5.png" alt="鲨鱼磁擦 ">
                                                                        </a>
                                                                        <a href="CC6.php" title="小蟹磁擦 ">
                                        <img src="<?php echo $site_url;?>out/b/77/cc6.png" alt="小蟹磁擦 ">
                                                                        </a>
                                                                        <a href="CC7.php" title="大肚鱼磁擦 ">
                                        <img src="<?php echo $site_url;?>out/b/77/cc7.png" alt="大肚鱼磁擦 ">
                                                                        </a>
                                                                        <a href="CC8.php" title="乌龟磁擦 ">
                                        <img src="<?php echo $site_url;?>out/b/77/cc8.png" alt="乌龟磁擦 ">
                                                                        </a>
                                                                        <a href="CC9.php" title="海螺磁擦 ">
                                        <img src="<?php echo $site_url;?>out/b/77/cc9.png" alt="海螺磁擦 ">
                                                                        </a>
                                    </div>
            </div>
...
<div class="tabs product-images">
    <div id="image-1">
        <a href="<?php echo $site_url;?>out/b/863/cc2.jpg" class="cloud-zoom">
            <img src="<?php echo $site_url;?>out/b/278/cc2.png" alt="" width="278" height="278">
        </a>
    </div>
     <!-- Bilder-Navigation -->
     <div class="clearfix">
                    <ul class="product-images-nav clearfix">
                            <li><a href="#image-1"><img src="<?php echo $site_url;?>out/b/50/cc2.png" alt=""></a></li>
                        </ul>
            </div>
    <!-- ende -> Tab-Navigation -->
</div>
...
<h2 class="tk-myriad-pro tk-light">海星磁擦 </h2>
<p class="desc">外壳采用增强ABS全新原材料，防腐蚀、耐酸碱，长久使用也不会污染水质。</p>
        ...
        <div class="tab-teaser accessories_detail-prod_detail">
            <h3>海星磁擦</h3>
            <p>采用优质树脂制作，品质更高，手感更舒适，超强稀土钕磁铁，磁性超强。新颖动物造型，，好动的河马，以星形得名的海星，浑身是刺的石头鱼，终生不眠的海豚，凶狠的鲨鱼，霸气的螃蟹，好吃蚊子的大肚鱼，幽远的海螺 ，惹人喜爱的乌龟。使用时将一块放入水族箱内，另一块放在缸外即可吸附一起，移动外面一块可带动里面一块随意活动，宛若栩栩如生的海底动物在缸内愉悦地玩耍。为您的鱼缸更添一份点缀且真实的气息。</p>
