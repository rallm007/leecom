...
<div class="tabs product-images">
    <div id="image-1">
    	<a href="<?php echo $site_url;?>out/pictures/master/product/main/zoom/1/88038.jpg" class="cloud-zoom">
    		<img src="<?php echo $site_url;?>out/pictures/master/product/main/detail/1/88038.png" alt="" width="278" height="278">
        </a>
    </div>
     <!-- Bilder-Navigation -->
     <div class="clearfix">
     	            <ul class="product-images-nav clearfix">
                            <li><a href="#image-1"><img src="<?php echo $site_url;?>out/pictures/master/product/main/thumb/1/88038.png" alt=""></a></li>
			            </ul>
		    </div>
    <!-- ende -> Tab-Navigation -->
</div>
