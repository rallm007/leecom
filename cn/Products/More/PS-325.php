        ...
        <h1 class="tk-myriad-pro tk-light">PS水泵系列</h1>
            ...
            <div class="slider-wrapper">
                <div class="product-thumbnail-slider clearfix">
                                        <a href="PS-315.php" title="PS-315 ">
                                        <img src="<?php echo $site_url;?>out/b/77/ps315.png" alt="PS-315 ">
                                                                        </a>
                                        <a href="PS-3w5.php" title="PS-325 " class="selected">
...
<div class="tabs product-images">
    <div id="image-1">
        <a href="<?php echo $site_url;?>out/b/863/ps325.jpg" class="cloud-zoom">
            <img src="<?php echo $site_url;?>out/b/278/ps325.png" alt="" width="278" height="278">
        </a>
    </div>
     <!-- Bilder-Navigation -->
     <div class="clearfix">
                    <ul class="product-images-nav clearfix">
                            <li><a href="#image-1"><img src="<?php echo $site_url;?>out/b/50/ps325.png" alt=""></a></li>
                        </ul>
            </div>
    <!-- ende -> Tab-Navigation -->
</div>
...
<h2 class="tk-myriad-pro tk-light">PS-325 </h2>
