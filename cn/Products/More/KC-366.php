            ...
            <div class="slider-wrapper">
                <div class="product-thumbnail-slider clearfix">
                                        ...
                                        <img src="<?php echo $site_url;?>out/b/77/kc365.png" alt="KC-365 ">
                                                                        ...
                                                                        <a href="KC-366.php" title="KC-366 " class="selected">
...
<div class="tabs product-images">
    <div id="image-1">
        <a href="<?php echo $site_url;?>out/b/863/kc366.jpg" class="cloud-zoom">
            <img src="<?php echo $site_url;?>out/b/278/kc366.png" alt="" width="278" height="278">
        </a>
    </div>
     <!-- Bilder-Navigation -->
     <div class="clearfix">
                    <ul class="product-images-nav clearfix">
                            <li><a href="#image-1"><img src="<?php echo $site_url;?>out/b/50/kc366.png" alt=""></a></li>
                        </ul>
            </div>
    <!-- ende -> Tab-Navigation -->
</div>
...
<h2 class="tk-myriad-pro tk-light">KC-366 </h2>
<p class="desc"></p>
        </div>                
        </div>
        <!-- ende -> oberer Bereich-->
