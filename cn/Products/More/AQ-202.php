...
<div id="main">
    ...
    <div class="product-thumbnail-navi accessories_detail-thumb-nav clearfix">
        <div class="page_margins ">
            <h1 class="tk-myriad-pro tk-light">系列</h1>
        </div>
                            ...
                            <div class="tabs product-images">
                                <div id="image-1">
                                    <a href="<?php echo $site_url; ?>out/b/863/aq202.jpg" class="cloud-zoom">
                                        <img src="<?php echo $site_url; ?>out/b/278/aq202.png" alt="" width="278"
                                             height="278">
                                    </a>
                                </div>
                                <!-- Bilder-Navigation -->
                                <div class="clearfix">
                                    <ul class="product-images-nav clearfix">
                                        <li><a href="#image-1"><img src="<?php echo $site_url; ?>out/b/50/aq202.png"
                                                                    alt=""></a></li>
                                    </ul>
                                </div>
                                <!-- ende -> Tab-Navigation -->
