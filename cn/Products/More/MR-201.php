            ...
            <div class="slider-wrapper">
                <div class="product-thumbnail-slider clearfix">
                                        ...
                                        <img src="<?php echo $site_url;?>out/b/77/mt100.png" alt="MT-100 止逆阀 ">
                                                                        ...
                                                                        <a href="MR-201.php" title="MR-201生化球 " class="selected">
                                        ...
                                        <img src="<?php echo $site_url;?>out/b/77/mr202.png" alt="MR-202生化球 ">
                                                                        ...
                                                                        <a href="MR-301.php" title="MR-301生化球 ">
...
<div class="tabs product-images">
    <div id="image-1">
        <a href="<?php echo $site_url;?>out/b/863/mr201.jpg" class="cloud-zoom">
            <img src="<?php echo $site_url;?>out/b/278/mr201.png" alt="" width="278" height="278">
        </a>
    </div>
     <!-- Bilder-Navigation -->
     <div class="clearfix">
                    <ul class="product-images-nav clearfix">
                            <li><a href="#image-1"><img src="<?php echo $site_url;?>out/b/50/mr201.png" alt=""></a></li>
                        </ul>
            </div>
    <!-- ende -> Tab-Navigation -->
</div>
...
<h2 class="tk-myriad-pro tk-light">MR-201生化球 </h2>
<p class="desc"></p>
        </div>                
        </div>
        <!-- ende -> oberer Bereich-->
