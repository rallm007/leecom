            ...
            <div class="slider-wrapper">
                <div class="product-thumbnail-slider clearfix">
                                        ...
                                        <img src="<?php echo $site_url;?>out/b/77/me001.png" alt="ME-001 L型气管接头 ">
                                                                        ...
                                                                        <a href="ME-002.php" title="ME-002 Y型气管三通 " class="selected">
...
<div class="tabs product-images">
    <div id="image-1">
        <a href="<?php echo $site_url;?>out/b/863/me002.jpg" class="cloud-zoom">
            <img src="<?php echo $site_url;?>out/b/278/me002.png" alt="" width="278" height="278">
        </a>
    </div>
     <!-- Bilder-Navigation -->
     <div class="clearfix">
                    <ul class="product-images-nav clearfix">
                            <li><a href="#image-1"><img src="<?php echo $site_url;?>out/b/50/me002.png" alt=""></a></li>
                        </ul>
            </div>
    <!-- ende -> Tab-Navigation -->
</div>
...
<h2 class="tk-myriad-pro tk-light">ME-002 Y型气管三通 </h2>
<p class="desc"></p>
        </div>                
        </div>
        <!-- ende -> oberer Bereich-->
        ...
        <div class="tab-teaser accessories_detail-prod_detail">
            <h3>ME-002 Y型气管三通</h3>
            <p>无毒、环保优质PVC材质，接上Y型氣管三通後，使出氣管由一分為二，可以接上2個氣動產品，也可以把两个气泵的气体合并到一根气管，轻松根据您的需要而合并或分散气体的大小。
适合4MM内径的气管</p>
