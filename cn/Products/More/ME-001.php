            ...
            <div class="slider-wrapper">
                <div class="product-thumbnail-slider clearfix">
                                        ...
                                        <img src="<?php echo $site_url;?>out/b/77/mr302.png" alt="MR-302生化球 ">
                                                                        ...
                                                                        <a href="ME-001.php" title="ME-001 L型气管接头 " class="selected">
...
<div class="tabs product-images">
    <div id="image-1">
        <a href="<?php echo $site_url;?>out/b/863/me001.jpg" class="cloud-zoom">
            <img src="<?php echo $site_url;?>out/b/278/me001.png" alt="" width="278" height="278">
        </a>
    </div>
     <!-- Bilder-Navigation -->
     <div class="clearfix">
                    <ul class="product-images-nav clearfix">
                            <li><a href="#image-1"><img src="<?php echo $site_url;?>out/b/50/me001.png" alt=""></a></li>
                        </ul>
            </div>
    <!-- ende -> Tab-Navigation -->
</div>
