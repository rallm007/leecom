...
<div class="simple-stage">
        ...
        <h1 class="tk-myriad-pro tk-light">附件系列</h1>
        <p>您不可或缺的鱼缸伴侣</p>
    </div>
    </div>
        ...
        <h1 class="tk-myriad-pro tk-light">附件系列</h1>
            ...
            <div class="slider-wrapper">
                <div class="product-thumbnail-slider clearfix">
                                        <a href="MT-100.php" title="MT-100 止逆阀 ">
                                        <img src="<?php echo $site_url;?>out/b/77/mt100.png" alt="MT-100 止逆阀 ">
                                                                        </a>
                                                                        <a href="MR-201.php" title="MR-201生化球 ">
                                        <img src="<?php echo $site_url;?>out/b/77/mr201.png" alt="MR-201生化球 ">
                                                                        </a>
                                                                        <a href="MR-202.php" title="MR-202生化球 ">
                                        <img src="<?php echo $site_url;?>out/b/77/mr202.png" alt="MR-202生化球 ">
                                                                        </a>
                                                                        <a href="MR-301.php" title="MR-301生化球 " class="selected">
                                        <img src="<?php echo $site_url;?>out/b/77/mr301.png" alt="MR-301生化球 ">
                                                                        </a>
                                                                        <a href="MR-302.php" title="MR-302生化球 ">
                                        <img src="<?php echo $site_url;?>out/b/77/mr302.png" alt="MR-302生化球 ">
                                                                        </a>
                                                                        <a href="ME-001.php" title="ME-001 L型气管接头 ">
                                        <img src="<?php echo $site_url;?>out/b/77/me001.png" alt="ME-001 L型气管接头 ">
                                                                        </a>
                                                                        <a href="ME-002.php" title="ME-002 Y型气管三通 ">
                                        <img src="<?php echo $site_url;?>out/b/77/me002.png" alt="ME-002 Y型气管三通 ">
                                                                        </a>
                                                                        <a href="ME-003.php" title="ME-003 气管接头直通 ">
                                        <img src="<?php echo $site_url;?>out/b/77/me003.png" alt="ME-003 气管接头直通 ">
                                                                        </a>
                                        <a href="MQ-100.php" title="MQ-100气管调节阀 ">
                                            <img src="<?php echo $site_url;?>out/b/77/mq100.png" alt="MQ-100气管调节阀 ">
                                        </a>
                                        <a href="QPS.php" title="气泡石 ">
                                            <img src="<?php echo $site_url;?>out/b/77/qps.png" alt="气泡石 ">
                                        </a>
                                    </div>
            </div>
    ...
    <ul class="fl">
        <li>您的位置:</li>
                                            <li><a href="../index.php" title="产品展示">产品展示</a></li>
                                                            <li><a href="../index.php" title="附件系列">附件系列</a></li>
                                        <li>MR-301生化球 </li>
            </ul>
</div>  
...
<div class="tabs product-images">
    <div id="image-1">
        <a href="<?php echo $site_url;?>out/b/863/mr301.jpg" class="cloud-zoom">
            <img src="<?php echo $site_url;?>out/b/278/mr301.png" alt="" width="278" height="278">
        </a>
    </div>
     <!-- Bilder-Navigation -->
     <div class="clearfix">
                    <ul class="product-images-nav clearfix">
                            <li><a href="#image-1"><img src="<?php echo $site_url;?>out/b/50/mr301.png" alt=""></a></li>
                        </ul>
            </div>
    <!-- ende -> Tab-Navigation -->
</div>
...
<script>
    ...
    (function(d, s, id){
        ...
        js.src = "<?php echo $site_url;?>../connect.facebook.net/en_GB/all.js";
        fjs.parentNode.insertBefore(js, fjs);
    }(document, 'script', 'facebook-jssdk'));
</script>

<h2 class="tk-myriad-pro tk-light">MR-301生化球 </h2>
<p class="desc"></p>
        </div>                
        </div>
        <!-- ende -> oberer Bereich-->
        ...
        <div class="tab-teaser accessories_detail-prod_detail">
            <h3>MR-301生化球</h3>
            <p>滤材中净化水质的利器，结合生化球及生化棉块双重结构，具有多重塑料骨架，可提供巨大表面积硝化细菌繁殖生长，并可防止因相互重叠而造成水流黑死区，透氧性更强。生化球的网孔结构，内部的多孔为硝化细菌的繁殖生长提供了巨大的生化表面积，内部生化棉加速细菌成熟，进一步提高了生化球的生化能力。</p>
