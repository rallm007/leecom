...
<div class="tabs product-images">
    <div id="image-1">
        <a href="<?php echo $site_url;?>out/img/detail/8/PS628_863.jpg" class="cloud-zoom">
            <img src="<?php echo $site_url;?>out/img/detail/8/PS628_278.png" alt="" width="278" height="278">
        </a>
    </div>
</div>
            </div>
...
<h2 class="tk-myriad-pro tk-light">PS-628 </h2>
<p class="desc"></p>
        </div>                
        </div>
        <!-- ende -> oberer Bereich-->
