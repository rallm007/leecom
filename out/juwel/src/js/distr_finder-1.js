...
$(function(){
		...
		// Javascript für die InfoBox-Funktion <script src="out/juwel/src/js/libs/infobox_packed-1.js"/*tpa=https://www.juwel-aquarium.de/out/juwel/src/js/out/juwel/src/js/libs/infobox_packed.js*/></script>
		// Javascript für die Labels innerhalb der Marker <script src="out/juwel/src/js/libs/markerwithlabel_packed-1.js"/*tpa=https://www.juwel-aquarium.de/out/juwel/src/js/out/juwel/src/js/libs/markerwithlabel_packed.js*/></script>
		...
		openStoreFinder = function(){
			$.colorbox({transition:'elastic', speed:300, opacity: 0.5, overlayClose: false, scrolling: false, width: 880, height: 650, inline:true, href: box,
								...
								onComplete:function(){ $('#colorbox').addClass('standard');
													   ...
													   // Tabs
													   global_parent.find('https://www.juwel-aquarium.de/out/juwel/src/js/.results .tabs').tabs();
								...
								onClosed:function(){
														...
														global_parent.find('https://www.juwel-aquarium.de/out/juwel/src/js/.results .tabs').tabs( "destroy" )
		...
		showResult = function( oLocation ) {
			...
			var start_icon = new google.maps.MarkerImage(
				'out/juwel/src/images/all/distr_finder-start_marker-1.png'/*tpa=https://www.juwel-aquarium.de/out/juwel/src/js/out/juwel/src/images/all/distr_finder-start_marker.png*/,
		...
		selectTabRoute = function() {
		  // Activate route tab
		  var global_parent = $('#distr_finder');
		  global_parent.find('https://www.juwel-aquarium.de/out/juwel/src/js/.results .tabs').tabs("select", 1);
		};
