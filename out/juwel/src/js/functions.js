	...
	*/
	...
	function panel_cart(){
		...
		.find(".item-delete, this")
				.tipsy({offset: 3, gravity: 'e', delayIn: 10, delayOut: 10, container: 'http://www.juwel-aquarium.de/out/juwel/src/js/.has-drop.cart .drop'}) // bind the tooltip
		...
		*/
		$('#panel-nav .panel-cart').on('click', 'http://www.juwel-aquarium.de/out/juwel/src/js/.button.grey',function(){ // close cart on click
