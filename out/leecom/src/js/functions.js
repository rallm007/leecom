...
$(function () {
    ...
    leecom.homeSlider = function () {
        ...
        function Slider() {
            ...
            slider_sel.carouFredSel({
                ...
                items: 1,
                auto: {
                    /* automatic scrolling after 7 seconds */
    ...
    leecom.detailStage = function () {
        ...
        function thumbnailNavi() {
            ...
            navi_sel.on('mouseenter', function () {
                ...
                el.find('.inner-wrapper').clearQueue().delay(200).animate({
                    height: '154px',
                    opacity: 1
                }, 800, "easeInOutQuart");
        ...
        function variationSlider() {
            main_slider_item.each(function () {
                ...
                var decors = parent.find(".variations ul li");
                /* decor images for selction */
    ...
    leecom.initLogin = function () {
        ...
        $.colorbox({
            ...
            onComplete: function () {
                $('form.login-form').jqTransform(); // replace from-elements
                box.addClass('standard');
                $.fn.resizeLoginBox();
            },
            onClosed: function () {
                box.removeClass('standard');
            }
