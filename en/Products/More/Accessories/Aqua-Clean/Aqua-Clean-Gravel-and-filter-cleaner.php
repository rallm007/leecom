    ...
    <li>    	
        <span>Digital-Thermometer</span>
	        ...
	        <li class="active">
	        	        <ul>
	            <li>
	                <a href="../Digital-Thermometer/Digital-Thermometer-2-0.php" tppabs="<?php echo $site_url;?>en/Products/More/Accessories/Digital-Thermometer/Digital-Thermometer-2-0.php">Digital Thermometer 2.0</a>	                
	            </li>
	        </ul>    
	        	        </li>
        </ul>
