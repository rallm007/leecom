            ...
            <div class="grid_8 push_1">
                ...
                <div class="clearfix accessories_detail_top">
                        ...
                        <div class="tabs product-images">
                            <div id="image-1">
                                <a href="<?php echo $site_url; ?>out/img/detail/9/CF600_863.jpg" class="cloud-zoom">
                                    <img src="<?php echo $site_url; ?>out/img/detail/9/CF600_278.png" alt="" width="278"
                                         height="278">
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="grid_4 omega accessories_detail_right" style="margin-top: 100px;">
                        ...
                        <h2 class="tk-myriad-pro tk-light">CF-600 top filter </h2>
                            ...
                            <div class="tab-teaser tab-teaser-technical">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>SC-60 Carbon cartridge replacement</td>
                                    </tr>
