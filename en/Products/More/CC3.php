        ...
        <div class="content clearfix accessories_detail">
            <div class="breadcrumb accessories-detail nav clearfix">
                <ul class="fl">
                    ...
                    <li>Stonefish magnetic brush</li>
                </ul>
            </div>
                ...
                <div class="clearfix accessories_detail_top">
                    <div class="grid_4 alpha accessories_detail_images">
                        ...
                        <div class="tabs product-images">
                            <div id="image-1">
                                <a href="<?php echo $site_url; ?>out/img/detail/4/shitouyu_863.jpg" class="cloud-zoom">
                                    <img src="<?php echo $site_url; ?>out/img/detail/4/shitouyu_278.png" alt="" width="278"
                                         height="278">
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="grid_4 omega accessories_detail_right" style="margin-top: 100px;">
                        ...
                        <h2 class="tk-myriad-pro tk-light">Stonefish magnetic brush </h2>
                    ...
                    <div class="tabs content-tabs">
                        ...
                        <div id="tabs-1">
                            ...
                            <div class="tab-teaser accessories_detail-prod_detail">
                                <h3>Stonefish magnetic brush</h3>
                            ...
                            <div class="tab-teaser tab-teaser-technical">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>Stonefish magnetic brush</td>
                                    </tr>
                                    <tr>
...
<div id="breadcrumb-bottom" class="nav">
    <div class="page_margins">
        <ul>
            <li><a href="../../../index.php" title="PRODUCTS">PRODUCTS</a></li>
            <li><a href="../index.php" title="Magnetic series">Magnetic series</a></li>
            <li><a href="#">Stonefish magnetic brush </a></li>
        </ul>
    </div>
</div>
