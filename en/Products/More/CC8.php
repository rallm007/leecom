                ...
                <div class="clearfix accessories_detail_top">
                    <div class="grid_4 alpha accessories_detail_images">
                        ...
                        <div class="tabs product-images">
                            <div id="image-1">
                                <a href="<?php echo $site_url; ?>out/img/detail/4/wugui_863.jpg" class="cloud-zoom">
                                    <img src="<?php echo $site_url; ?>out/img/detail/4/wugui_278.png" alt=""
                                         width="278">
                                </a>
                            </div>
                    ...
                    <div class="grid_4 omega accessories_detail_right" style="margin-top: 100px;">
                        ...
                        <h2 class="tk-myriad-pro tk-light">Tortoise magnetic brush </h2>
...
<div id="breadcrumb-bottom" class="nav">
    <div class="page_margins">
        <ul>
            <li><a href="../../../index.php" title="PRODUCTS">PRODUCTS</a></li>
            <li><a href="../index.php" title="Magnetic series">Magnetic series</a></li>
            <li><a href="#">Tortoise magnetic brush </a></li>
        </ul>
    </div>
</div>
