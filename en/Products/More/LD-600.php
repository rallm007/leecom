                    ...
                    <li>
                        ...
                        <ul>
                            <li class="active">
                                ...
                                <ul>
                                    <li>
                                        <a href="LD-036.php">LD-036 </a>
                                    </li>
                                </ul>
                                <ul>
                                    <li>
                                        <a href="LD-040.php">LD-040 </a>
                                    </li>
                                </ul>
                                <ul>
                                    <li>
                                        <a href="LD-046.php">LD-046 </a>
                                    </li>
                                </ul>
                                <ul>
                                    <li>
            ...
            <div class="grid_8 push_1">
                ...
                <div class="clearfix accessories_detail_top">
                    ...
                    <div class="grid_4 omega accessories_detail_right" style="margin-top: 100px;">
                        ...
                        <h2 class="tk-myriad-pro tk-light">LD-600 </h2>
