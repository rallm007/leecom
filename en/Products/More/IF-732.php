        ...
        <div class="content clearfix accessories_detail">
            <div class="breadcrumb accessories-detail nav clearfix">
                <ul class="fl">
                    ...
                    <li><a href="IF-730.php" title="IF Series">IF Series</a></li>
                    <li>IF-732</li>
                </ul>
            </div>
                        ...
                        <div class="tabs product-images">
                            <div id="image-1">
                                <a href="<?php echo $site_url; ?>out/img/detail/10/IF732_863.jpg" class="cloud-zoom">
                                    <img src="<?php echo $site_url; ?>out/img/detail/10/IF732_278.png" alt=""
...
<div id="breadcrumb-bottom" class="nav">
    <div class="page_margins">
        <ul>
            <li><a href="../index.php" title="PRODUCTS">PRODUCTS</a></li>
            <li><a href="../index.php" title="Filter air series">Filter air series</a></li>
            <li><a href="#" title="IF Series">IF Series</a></li>
        </ul>
    </div>
</div>
