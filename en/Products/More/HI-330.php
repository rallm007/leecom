        ...
        <div class="content clearfix accessories_detail">
            <div class="breadcrumb accessories-detail nav clearfix">
                <ul class="fl">
                    ...
                    <li><a href="../index.php" title="Hang-on filter series">Hang-on filter series</a></li>
                    <li>HI-330</li>
                </ul>
            </div>
            ...
            <div class="grid_3 nav">
                ...
                <ul class="sub-nav">
                    ...
                    <li class="active">
                        <span>Hang-on filter series</span>
                        ...
                        <div class="tabs product-images">
                            <div id="image-1">
                                <a href="<?php echo $site_url; ?>out/img/detail/7/HI330_863.jpg" class="cloud-zoom">
                                    <img src="<?php echo $site_url; ?>out/img/detail/7/HI330_278.png" alt="" width="278"
                                         height="278">
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="tabs content-tabs">
                        ...
                        <div id="tabs-1">
                            ...
                            <div class="tab-teaser accessories_detail-prod_detail">
                                ...
                                <p>
                                    时尚美观，瀑布式流水设计，高仿大自然的流水规律，超静，仅听见潺潺流水的声音，为鱼儿提供充足的氧气，令鱼儿更活跃，水族世界更精彩。外壳采用优质增强型ABS原材料，坚固耐用，防腐蚀、耐酸碱、经久耐用，性能更卓越，过滤泵头主体部份全部采用进口铜线，性能更高，更有效省电，顶部灌胶密封，杜绝漏电安全隐患。三重过滤的 Carbon cartridge replacement，不但替换方便，性能更出色，当中的高效活性炭有效净化水质，令水质更清澈；高密度过滤棉可吸附Aquariums内残留的鱼铒、鱼烘等杂质，和高效生化棉最大程度保证水质的洁净。可调试流量的调节阀，自由调节最适合水流量及溶氧量以供生物生长，专业油膜处理技术，独特的油膜吸头设计，使之高效快速吸收水面油膜，以给您的爱鱼一个最洁净而温馨的家。</p>
