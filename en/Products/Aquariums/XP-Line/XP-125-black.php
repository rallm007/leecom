...
<script>
	...
	loadContentByArtId = function( sArtId ) {
		...
		// 	var sUrl = "https://www.juwel-aquarium.de/en/Products/Aquariums/XP-Line/XP-125-black.php#!juwel-000000000000001300cl=srajax";
		// } else {
    ...
    <div class="page_margins">
        <ul>
		    <li><a href="../../index.php" title="Products">Products</a></li>
				<li><a href="XC-180-black.php" title="XC-Line">XP-Line</a></li>
	        </ul>                        
    </div>
</div>
