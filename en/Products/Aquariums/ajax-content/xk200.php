<div class="tabs content-tabs full ui-tabs ui-widget ui-widget-content ui-corner-all">
    ...
    <div id="tabs-1" class="ui-tabs-panel ui-widget-content ui-corner-bottom">
        ...
        <div class="tab-teaser-prod_details top clearfix">
            <div class="grid_8">
                <h2>XK - 200 contracted decorous, design classics</h2>

                <p>This meticulously by our engineers integrating filtration system and energy-saving lighting system of
                    rectangular aquarium, with makings fastidious, easy to operate, every corner made by the top
                    engineering plastic raw materials, waterproof switch cap is your security guards work 24 hours.Can
                    replace the water quality in the upper part of the filter to the filter material you always keep the
                    most clean state.</p>
            </div>
            <!-- <div class="grid_4">
        ...
        <div id="filter" class="tab-teaser-prod_details clearfix">
            <div class="grid_8">
                ...
                <p>Energy conservation and environmental protection high brightness leds, would like to open it on to
                    ...
                    meet your simple fashion taste.<br></p>
    ...
    <div id="tabs-2" class="ui-tabs-panel ui-widget-content ui-corner-bottom ui-tabs-hide">
        <div class="tab-teaser-technical clearfix">
            ...
            <table>
                <thead>
                <tr>
                    <td colspan="3">XK-200 Mini aquarium</td>
                </tr>
                </thead>
                <tbody>
                <tr>
