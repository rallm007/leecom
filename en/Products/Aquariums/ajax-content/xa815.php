<div class="tabs content-tabs full ui-tabs ui-widget ui-widget-content ui-corner-all">
    ...
    <div id="tabs-1" class="ui-tabs-panel ui-widget-content ui-corner-bottom">
        ...
        <div class="tab-teaser-prod_details top clearfix">
            <div class="grid_8">
                <h2>XA - 815 professional match, having a unique style of open design</h2>

                <p>
                    Trial and error and precipitation of professional collocation, all-round to meet your different
                    needs, open design makes you add water or hurl food is so convenient, the pump of gas grand quietly
                    enter a steady stream of oxygen for water goblins, forever not only keep the water clean, also
                    ensure your love fish there would always be enough oxygen.The 0.7 W leds is not only safe forever,
                    but also add a light for your tank, give you add a feminine beauty love fish.</p>
            </div>
            <div class="grid_4">
    ...
    <div id="tabs-2" class="ui-tabs-panel ui-widget-content ui-corner-bottom ui-tabs-hide">
        <div class="tab-teaser-technical clearfix">
            ...
            <table>
                <thead>
                <tr>
                    <td colspan="3">XA-815 Mini aquarium</td>
                </tr>
                </thead>
                <tbody>
                <tr>
