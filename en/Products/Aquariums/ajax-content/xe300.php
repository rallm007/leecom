    ...
    <div id="tabs-1" class="ui-tabs-panel ui-widget-content ui-corner-bottom">
        ...
        <div class="tab-teaser-prod_details top clearfix">
            <div class="grid_8">
                ...
                <p>
                    Perfect streamline modelling, humanized rounded design, high-end atmosphere, safe use.Classic aquatic cylinder design, having a unique style of open mode design, elegant and delicate.Provide a lighting, filtering, increasing oxygen in the integration of the ecological environment, let you moment at close range, more clear, feel the nature.Glass glittering and translucent get rid of is appeared, colour diversity, can put office also can use household, let you bring home nature.Health be with you!
                    <br/><br/>Black and white for your choice.<br/>
High brightness SMD type LED lamp, lamp more optional.</p>
            </div>
            <div class="grid_4">
...
Three gears switch give you different visual feeling, light and shade to form different style.The switch waterproof cap safety design to eliminate any potential safety hazard.<br>
    ...
    <div id="tabs-2" class="ui-tabs-panel ui-widget-content ui-corner-bottom ui-tabs-hide">
        <div class="tab-teaser-technical clearfix">
            <div class="image">
                <img src="../../../../out/pictures/generated/srcms/1/618_342_80/00010_1xt.jpg" alt="">
            </div>
            <table>
                <thead>
                <tr>
                    <td colspan="3">XE-300 Aquarium</td>
                </tr>
                </thead>
                <tbody>
                <tr>
        ...
        <div class="tab-teaser-technical clearfix">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td class="topic">Saving lamp power</td>
                    <td>13 W</td>
                </tr>
                </tbody>
            </table>
        ...
        <div class="tab-teaser-technical clearfix">
            ...
            <table>
                <thead>
                <tr>
                    <td colspan="3">TR-300 Cabinet<br>
                    </td>
                </tr>
                </thead>
                <tbody>
