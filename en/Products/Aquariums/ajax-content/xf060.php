<div class="tabs content-tabs full ui-tabs ui-widget ui-widget-content ui-corner-all">
    ...
    <div id="tabs-1" class="ui-tabs-panel ui-widget-content ui-corner-bottom">
        ...
        <div class="tab-teaser-prod_details top clearfix">
            <div class="grid_8">
                <h2>XF - 060 - plastic also shining brilliantly, luxury and elegance</h2>

                <p>Novel design, high level of glass transparency, fine workmanship, coordination and beautiful,
                    impeccable, reflect the most natural beauty, is the best magic weapon that occupy the home, office
                    close to nature, give you add a little green, enjoy the original ecological.Switch waterproof cap is
                    24 hours security guard from work, you can replace the upper part of the filter to the filter
                    material you always keep the clean water quality state, small feeding feeding or password you add
                    water is so convenient.
    ...
    <div id="tabs-2" class="ui-tabs-panel ui-widget-content ui-corner-bottom ui-tabs-hide">
        <div class="tab-teaser-technical clearfix">
            ...
            <table>
                <thead>
                <tr>
                    <td colspan="3">XK-060 Mini aquarium</td>
                </tr>
                </thead>
                <tbody>
                <tr>
