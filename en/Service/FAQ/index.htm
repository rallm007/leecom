...
<!-- /Navi ohne Warenkorb -->
    ...
    <div class="drop">
        <ul>
                    ...
                    <li><a class="en_GB" title="English" href="index.htm" tppabs="http://www.juwel-aquarium.de/en/Service/FAQ/" hreflang="en" onclick="_gaq.push(['_trackEvent', 'Sprachselektor', 'click', 'English']);">English</a></li>
	...
	<ul>
			...
			<ul>			
    	            ...
    	            <div class="drop-btm"></div>
							...
							<div class="drop">
					<ul>
					                                        	                      		<li><a href="index.htm" tppabs="http://www.juwel-aquarium.de/en/Service/FAQ/" onclick="_gaq.push(['_trackEvent', 'FAQ Quelle', 'click', 'Servicecenter']);">FAQ</a></li>
                      	                                        	                      		<li><a href="../Downloadcenter/index.htm" tppabs="http://www.juwel-aquarium.de/en/Service/Downloadcenter/" onclick="_gaq.push(['_trackEvent', 'Downloadquelle', 'click', 'Downloadcenter']);">Downloadcenter</a></li>
...
<div class="content clearfix service">
    ...
    <div class="breadcrumb nav clearfix">
        <ul class="fl">
            <li>You are here:</li>
            	            	            <li><a href="../index.htm" tppabs="http://www.juwel-aquarium.de/en/Service/">Service</a></li>
	            <li>FAQ</li>
                    </ul>
    </div>
    <!-- ende-> Breadcrumb -->
    		...
    		<ul class="sub-nav simple">
			    ...
			    <li class="active">
			        <span>FAQ</span>
		        	    					    			    			    ...
		        	    					    			    			    <li>
		        	<a href="../Downloadcenter/index.htm" tppabs="http://www.juwel-aquarium.de/en/Service/Downloadcenter/">Downloadcenter</a>
		        </li>
...
This complex production process makes it particularly easy to cut the colour backgrounds to size whilst providing an extremely tough, colourfast surface. </p></div>
            ...
            <!-- Formular -->
                ...
                <form class="jqtransform" onSubmit="return false;">
                    <div>
                                                <input type="hidden" name="c_mach" value="rou2cbc5bfaa1d7e988de08017deebec"/>
                    </div>
                            ...
                            <div class="inner">
                                ...
                                <div class="form-row form-text required captcha-faq">
                                    ...
                                    <label>Enter Verification code:*</label>
                                        ...
                                        <img class="captcha-faq--image" id="verifyImageUrl" src="../../../core/utils/verificationimg.php-e_mac=ox_DRNfXVtCV0JE.png" tppabs="http://www.juwel-aquarium.de/core/utils/verificationimg.php?e_mac=ox_DRNfXVtCV0JE" alt="">
...
<!-- Footer-Area -->
    ...
    <div class="page_margins">
        <ul>
						    <li><a href="../index.htm" tppabs="http://www.juwel-aquarium.de/en/Service/" title="Service">Service</a></li>
			    						    <li><a href="index.htm" tppabs="http://www.juwel-aquarium.de/en/Service/FAQ/" title="FAQ">FAQ</a></li>
			    			        </ul>                        
    </div>
</div>
<div id="footer">
