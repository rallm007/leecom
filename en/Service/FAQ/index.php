...
<div class="content clearfix service">
    ...
    <div class="breadcrumb nav clearfix">
        <ul class="fl">
            <li>You are here:</li>
            	            	            <li><a href="../index.php" tppabs="<?php echo $site_url;?>en/Service/">Service</a></li>
	            <li>FAQ</li>
                    </ul>
    </div>
    <!-- ende-> Breadcrumb -->
...
This complex production process makes it particularly easy to cut the colour backgrounds to size whilst providing an extremely tough, colourfast surface. </p></div>
    ...
    <option value="MRS">Mrs</option>
                            ...
                            <div class="inner">
                                ...
                                <div class="form-row form-text required captcha-faq">
                                    ...
                                    <label>Enter Verification code:*</label>
                                        ...
                                        <img class="captcha-faq--image" id="verifyImageUrl" src="../../../core/utils/verificationimg.php-e_mac=ox_DRNfXVtCV0JE.png" tppabs="<?php echo $site_url;?>core/utils/verificationimg.php?e_mac=ox_DRNfXVtCV0JE" alt="">
                    ...
                    <div class="checkout-bottom-buttons clearfix">
                        ...
                        <img src="../../../out/juwel/src/images/all/forms/ajax_loader.gif" tppabs="<?php echo $site_url;?>out/juwel/src/images/all/forms/ajax_loader.gif" alt="loading" class="ajax-loader fr" />
                    </div>
                </form>
            </div>
                        <!-- ende -> Formular -->
...
<!-- Footer-Area -->
    ...
    <div class="page_margins">
        <ul>
						    <li><a href="../index.php" tppabs="<?php echo $site_url;?>en/Service/" title="Service">Service</a></li>
			    						    <li><a href="index.php" tppabs="<?php echo $site_url;?>en/Service/FAQ/" title="FAQ">FAQ</a></li>
			    			        </ul>                        
    </div>
</div>
