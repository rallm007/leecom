...
<head>
	...
	<!--[if lt IE 9]>
	    ...
	    <script src="<?php echo $site_url;?>out/juwel/src/js/plugins/jquery-extra-selectors.js" type="text/javascript"></script>
...
<div class="clearfix" id="header">
    <div class="page_margins">
        <div id="logo">
            <a title="LEECOM" href="<?php echo $site_url;?>index.php-lang=1&amp;.php" class="ir">LEECOM</a>
        </div>
        <!-- panel -->
...
<!-- /Navi ohne Warenkorb -->
    ...
    <div class="drop">
        <ul>
                    ...
                    <li><a onclick="_gaq.push(['_trackEvent', 'Sprachselektor', 'click', 'English']);" hreflang="en" href="Rio-125-black.php#!juwel-000000000000001300" title="English" class="en_GB">English</a></li>
        </ul>
			...
			<ul>			
                        ...
                        <div class="grid_7 right">
	                            	...
	                            	<div class="image">
                                    	...
                                    	<img alt="Rekord Line" src="<?php echo $site_url;?>out/pictures/master/product/2/21600.jpg">
                                    	                                   		                                </div>
	                                <div class="descr clearfix">
