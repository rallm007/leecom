...
<head>
                            <title>JUWEL庐 Aquarium | Contact</title>
...
<!-- /Navi ohne Warenkorb -->
    ...
    <div class="drop">
        <ul>
                    ...
                    <li><a class="fr_FR" title="Fran莽ais" href="index.php-lang=2&cl=contact.htm" tppabs="http://www.juwel-aquarium.de/index.php?lang=2&cl=contact" hreflang="fr" onclick="_gaq.push(['_trackEvent', 'Sprachselektor', 'click', 'Fran莽ais']);">Fran莽ais</a></li>
                    <li><a class="ru_RU" title="袪褍褋褋泻懈泄" href="index.php-lang=3&cl=contact.htm" tppabs="http://www.juwel-aquarium.de/index.php?lang=3&cl=contact" hreflang="ru" onclick="_gaq.push(['_trackEvent', 'Sprachselektor', 'click', '袪褍褋褋泻懈泄']);">袪褍褋褋泻懈泄</a></li>
...
<form class="jqtransform" action="https://www.juwel-aquarium.de/index.php?lang=1&force_sid=ds78nl6i1fgkoiqscpu0aj9tl3&" method="POST">
    <div>
        <input type="hidden" name="fnc" value="send"/>
        <input type="hidden" name="cl" value="contact"/>
                <input type="hidden" name="c_mach" value="ds7079d51e175c589363ae2acb43372d"/>
    </div>
	<!-- Formularfelder -->
    <div class="clearfix">
    ...
    <option value="MRS">Mrs</option>
        ...
        <div class="form-row form-text required">
            <label>Enter Verification code:*</label>
                ...
                <img class="captcha-image--contact" id="verifyImageUrl" src="core/utils/verificationimg.php-e_mac=ox_DRMKFwlWXkJE.png" tppabs="http://www.juwel-aquarium.de/core/utils/verificationimg.php?e_mac=ox_DRMKFwlWXkJE" alt="">
...
<p class="lh20">Find quick answers to frequently asked questions in our question and answer (FAQ) section</p> <a class="arrow-link" href="index-1.php-lang=1&force_sid=ds78nl6i1fgkoiqscpu0aj9tl3&cl=alist&cnid=deservice1.htm" tppabs="https://www.juwel-aquarium.de/index.php?lang=1&force_sid=ds78nl6i1fgkoiqscpu0aj9tl3&cl=alist&cnid=deservice1" title="FAQ">FAQ</a>      </div>
<div class="contact_newsletter">
<p class="lh20">Register for our newsletter now and keep up-to-date at all times.</p><a class="arrow-link" href="index-1.php-lang=1&force_sid=ds78nl6i1fgkoiqscpu0aj9tl3&cl=newsletter.htm" tppabs="https://www.juwel-aquarium.de/index.php?lang=1&force_sid=ds78nl6i1fgkoiqscpu0aj9tl3&cl=newsletter" title="Subscribe Nesletter">Subscribe Nesletter</a>      </div>
...
<!-- Footer-Area -->
    ...
    <div class="page_margins">
        <ul>
						    <li><a href="index.php-lang=1&cl=contact.htm" tppabs="http://www.juwel-aquarium.de/index.php?lang=1&cl=contact" title="Contact">Contact</a></li>
			    			        </ul>                        
    </div>
</div>
<div id="footer">
    <div class="page_margins bg">
        	...
        	<h4>Service</h4>
				...
				<ul>
                                   	                   		<li><a href="en/Service/FAQ/index.htm" tppabs="http://www.juwel-aquarium.de/en/Service/FAQ/" onclick="_gaq.push(['_trackEvent', 'FAQ Quelle', 'click', 'Servicecenter']);">FAQ</a></li>
                   	                                   	                   		<li><a href="en/Service/Downloadcenter/index.htm" tppabs="http://www.juwel-aquarium.de/en/Service/Downloadcenter/" onclick="_gaq.push(['_trackEvent', 'Downloadquelle', 'click', 'Downloadcenter']);">Downloadcenter</a></li>
                   	                                   	                   		<li><a href="index-1.php-lang=1&force_sid=ds78nl6i1fgkoiqscpu0aj9tl3&cl=newsletter.htm" tppabs="https://www.juwel-aquarium.de/index.php?lang=1&force_sid=ds78nl6i1fgkoiqscpu0aj9tl3&cl=newsletter">Newsletter</a></li>
                   	                	            </ul>
					</div>
            ...
            <div class="newsletter">
				<form action="https://www.juwel-aquarium.de/index.php?lang=1&force_sid=ds78nl6i1fgkoiqscpu0aj9tl3&" method="post">
				    <input type="hidden" name="stoken" value="B902C91B"><input type="hidden" name="force_sid" value="ds78nl6i1fgkoiqscpu0aj9tl3">
<input type="hidden" name="lang" value="1">
    ...
    <div class="box-head"><h2>Dealer Area</h2></div>
        ...
        <div class="grid_4 alpha register-teaser">
            <div class="inner">
                ...
                <form class="jqtransformx login-form" id="login" name="login" action="https://www.juwel-aquarium.de/index.php?lang=1&force_sid=ds78nl6i1fgkoiqscpu0aj9tl3&" method="post">
		            <input type="hidden" name="stoken" value="B902C91B"><input type="hidden" name="force_sid" value="ds78nl6i1fgkoiqscpu0aj9tl3">
<input type="hidden" name="lang" value="1">
...
$(function(){
	...
	searchHandler = function( oLocation, distance, iOfficial, iSeawater ) {
		...
		if( 'https:' == document.location.protocol ) {
			var sUrl = "https://www.juwel-aquarium.de/index.php?lang=1&amp;force_sid=ds78nl6i1fgkoiqscpu0aj9tl3&amp;";
		} else {
