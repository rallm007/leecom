...
<div class="hidden">
	<!-- AGB (Lightbox-Content) - wird in light-box eingefÃ¼gt (Aufruf Ã¼ber: juwel.contentLightBox('#agb-box') - siehe unten -->
...
<p>The exclusive object of the agreement shall be the sold JuwelÂ®
...
Rotenburg/WÃ¼mme (County Court Rotenburg/WÃ¼mme or -
...
<p>Juwel Aquarium GmbH & Co. KG, Karl-GÃ¶x-StraÃŸe 1, D -
27356 Rotenburg/WÃ¼mme, County Court Rotenburg HRA 1382</p>
<p>General partners: Juwel Aquarium GmbH, County Court Rotenburg, HRB
413, Annemarie KÃ¶hlmoos, Rosengarten</p>
<p>Managing Directors of Juwel Aquarium GmbH: Gerd KÃ¶hlmoos,
Annemarie KÃ¶hlmoos, Lars Larsen, Wolfgang DÃ¼rmeyer</p></td></tr></tbody></table></div>
	        </div>
	    </div>
	</div>
...
$(function(){
	...
	searchHandler = function( oLocation, distance, iOfficial, iSeawater ) {
		...
		if( 'https:' == document.location.protocol ) {
			var sUrl = "<?php echo $site_url;?>en/Products/Aquariums/XC-Line/XC-180-black.php#!juwel-xc300b";
		} else {
